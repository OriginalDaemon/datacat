...
Write-Host "Web UI will be available at http://localhost:8081" -ForegroundColor Cyan
Write-Host "Make sure the datacat server is running at http://localhost:8080" -ForegroundColor Yellow
